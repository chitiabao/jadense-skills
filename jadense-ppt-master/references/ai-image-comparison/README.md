...
python3 ${SKILL_DIR}/scripts/image_gen.py \
    --manifest ${SKILL_DIR}/references/ai-image-comparison/rendering/_manifest.json \
    -o ${SKILL_DIR}/references/ai-image-comparison/rendering/ \
    --backend openai

python3 ${SKILL_DIR}/scripts/image_gen.py \
    --manifest ${SKILL_DIR}/references/ai-image-comparison/palette/_manifest.json \
    -o ${SKILL_DIR}/references/ai-image-comparison/palette/ \
    --backend openai

python3 ${SKILL_DIR}/scripts/image_gen.py \
    --manifest ${SKILL_DIR}/references/ai-image-comparison/type/_manifest.json \
    -o ${SKILL_DIR}/references/ai-image-comparison/type/ \
    --backend openai
```
