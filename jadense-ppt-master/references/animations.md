...
python3 ${SKILL_DIR}/scripts/animation_config.py list-groups <project>

# Build a neutral editable scaffold from the post-regroup anchors when useful
python3 ${SKILL_DIR}/scripts/animation_config.py scaffold <project>

# Validate references before export
python3 ${SKILL_DIR}/scripts/animation_config.py validate <project>
...
- Run `python3 ${SKILL_DIR}/scripts/pptx_animations.py --describe
...
python3 ${SKILL_DIR}/scripts/sound_sync.py list
python3 ${SKILL_DIR}/scripts/sound_sync.py list --query <term>

# Materialize only the chosen ids
python3 ${SKILL_DIR}/scripts/sound_sync.py \
...
python3 ${SKILL_DIR}/scripts/svg_to_pptx.py <project> -t push --transition-duration 0.6

# Remove the visual transition
python3 ${SKILL_DIR}/scripts/svg_to_pptx.py <project> -t none

# Auto-advance every 5 seconds (kiosk-style playback)
python3 ${SKILL_DIR}/scripts/svg_to_pptx.py <project> --auto-advance 5

# Auto-advance with no visual transition
python3 ${SKILL_DIR}/scripts/svg_to_pptx.py <project> -t none --auto-advance 5
```
...
```bash
python3 ${SKILL_DIR}/scripts/pptx_animations.py --list
```
