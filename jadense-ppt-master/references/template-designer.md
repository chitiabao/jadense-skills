...
- **Workspace root**: `library` (default) → `${SKILL_DIR}/templates/<kind_dir>/<template_name>/`; `project` → the confirmed `<target_project>/`
...
|---|---|
| `library` | `${SKILL_DIR}/templates/<kind_dir>/<template_name>/` |
