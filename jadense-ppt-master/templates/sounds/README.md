...
```bash
python3 ${SKILL_DIR}/scripts/sound_sync.py list --query whoosh
python3 ${SKILL_DIR}/scripts/sound_sync.py projects/deck bigsoundbank/1797 kenney-interface/click_001
```
...
python3 ${SKILL_DIR}/scripts/sound_sync.py list --query transition
python3 ${SKILL_DIR}/scripts/sound_sync.py list --query recommended
```
