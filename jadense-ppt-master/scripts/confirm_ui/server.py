#!/usr/bin/env python3
"""
Jadense 学术 PPT Master - Template and Strategist confirmation UI Server (Steps 3-4)
...
from server_common import (  # noqa: E402
    ...
    detached_health_pid_matches as _detached_health_pid_matches,
        ...
        try:
            with urllib.request.urlopen(health_url, timeout=1) as resp:
                ...
                if (
                    ...
                    and _detached_health_pid_matches(proc.pid, data.get('pid'))
                ):
                    return True
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description='Jadense 学术 PPT Master template and Strategist confirmation UI',
