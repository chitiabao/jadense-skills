...
inline-smoke convention; do not turn it into a test file or example deck. This
derivative Skill is self-contained and does not depend on a repository-level
code-style document.
