...
import { SEARCH_PROVIDER_IDS, type DateRange, type PaperCandidate, type SearchProviderId } from "./types.js"
...
export function isCandidateWithinDateRange(candidate: PaperCandidate, dateRange: DateRange): boolean {
